...
### Modals
  ...
  - **Notification Settings Modal (`NotificationSettingsModal.razor`)**
    - Allows users to configure notification preferences, including frequency and types of notifications.
